...
export function CardSkeleton() {
  return (
    <div className={`animate-pulse  border border-solid border-gray/20 rounded-md overflow-hidden `}>
      ...
      {/* body  */}
      <div className="p-1 text-sm flex flex-col justify-between h-44">
        <div className="space-y-1 child:  child:">
          <div>
...
export function CardsSkeleton({ cards }: {
  cards: number
}) {

  const arr = new Array(cards).fill("")
  return arr?.map((item, index) => <CardSkeleton key={index} />)
}

export function RevenueChartSkeleton() {
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      <div className="mb-4 h-8 w-36 rounded-md bg-gray/70-100" />
      <div className="rounded-xl bg-gray/70-100 p-4">
  ...
  return (
    <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4">
      <div className="flex items-center">
        <div className="mr-2 h-8 w-8 rounded-full bg-gray/70-200" />
        <div className="min-w-0">
          <div className="h-5 w-40 rounded-md bg-gray/70-200" />
...
export function LatestInvoicesSkeleton() {
  return (
    ...
    >
      <div className="mb-4 h-8 w-36 rounded-md bg-gray/70-100" />
      <div className="flex grow flex-col justify-between rounded-xl bg-gray/70-100 p-4">
...
export default function DashboardSkeleton() {
  return (
    <>
      <div
        className={`${shimmer} relative mb-4 h-8 w-36 overflow-hidden rounded-md bg-gray/70-100`}
      />
    ...
    <tr className="w-full border-b border-gray-100 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <td className="relative overflow-hidden whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-full bg-gray/70-100"></div>
          <div className="h-6 w-24 rounded bg-gray/70-100"></div>
        </div>
      </td>
      {/* Email */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-32 rounded bg-gray/70-100"></div>
      </td>
      {/* Amount */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-16 rounded bg-gray/70-100"></div>
      </td>
      {/* Date */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-16 rounded bg-gray/70-100"></div>
      ...
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex justify-end gap-3">
          <div className="h-[38px] w-[38px] rounded bg-gray/70-100"></div>
          <div className="h-[38px] w-[38px] rounded bg-gray/70-100"></div>
        </div>
      </td>
    </tr>
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8">
        <div className="flex items-center">
          <div className="mr-2 h-8 w-8 rounded-full bg-gray/70-100"></div>
          <div className="h-6 w-16 rounded bg-gray/70-100"></div>
        </div>
        <div className="h-6 w-16 rounded bg-gray/70-100"></div>
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-16 rounded bg-gray/70-100"></div>
          <div className="mt-2 h-6 w-24 rounded bg-gray/70-100"></div>
        </div>
        <div className="flex justify-end gap-2">
          <div className="h-10 w-10 rounded bg-gray/70-100"></div>
          <div className="h-10 w-10 rounded bg-gray/70-100"></div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray/70-50 p-2 md:pt-0">
